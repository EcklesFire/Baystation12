...
/decl/cultural_info/culture/human/martian_surfacer
	...
	average level of comfort expected in Sol space. Most surfacers are like many across the galaxy, though a few harbour rivalries \
	with other Martian cultural	groups or are generally overly proud of their heritage, as is the case with the Gideons, to the point that they constantly refer to it."
	secondary_langs = list(LANGUAGE_SOL_COMMON)
	economic_power = 1
...
/decl/cultural_info/culture/human/luna_poor
	...
	description = "You are from Luna, a natural satellite of Earth and home to some of the richest, mostly highly cultured or influential people humanity has. \
	Unfortunately, you are most certainly not one of them.While Luna is known for its richness, the arts, culture and old money, it is also home to a sizeable \
 	population of working poor or middle-lower income persons. Typically the corporate employees of one of the various corporations, persons hired in service \
 	roles in one of the many prefectures or a resident of New Vegas. The 'poor' of Luna typically resent the rich because of their financial, cultural and political power and influence over their lives."
...
/decl/cultural_info/culture/human/luna_rich
	...
	description = "You are from Luna, Earths only natural satellite and home to some of the richest, most highly cultured, or influential people of humanity. \
	Fortunately for you, you are one of this elite and well off class of people. The rich of Luna are politically and economically influential not just in Luna,\
	but in the various corporations, organizations and government bodies of the SCG. Luna’s upper class isn’t equal; generally divided between new, corporate money \
	and old, dynastic money; many members of the old dynasties look down on the newly wealthy. Much of the elite of Luna is embroiled in 'The Game' a state of political \
	manoeuvring and intrigue among various factions and persons of influence and power with implications far beyond the squabbles of the prefectures."
...
/decl/cultural_info/culture/human/venusian_upper
	...
	description = "You are from one of the many zones of Venus. Floating high above the ground of the planet on massive platforms, you are one of the many who live on \
	one of the most decadent locations in the SCG. As a Venusian, you know luxury, wealth and entertainment. Primarily a tourist destination, many of the permanent\
	residents work in the tourism industry and are notably middle-income. Those above are exceptionally wealthy, being hotel, casino, resort owners, politicians, bankers or rich retirees."
	secondary_langs = list(LANGUAGE_SOL_COMMON, LANGUAGE_LUNAR)
	economic_power = 1.4

/decl/cultural_info/culture/human/venusian_surfacer
	name = CULTURE_HUMAN_VENUSLOW
	description = "You are from the surface of Venus, one of many employed in mining, industry and services industries. Venusian Surfacers are fairly poor, especially \
	compared to Zoners and have far lower standards of living than those above. A hardy people who spend much of their time working in mostly unpleasant conditions in order \
	to prop up the society above, surfacers are a people who value hard work, solidarity, unity and democracy. Unfortunately, while they support noble ideals, the reality of \
	their situation does not always match them, and much of the surface of Venus finds itself rife with organised crime, separatist groups and other criminal organisations."
